...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "APP_ID:DbaSY33oQnAm8YqaSjM1s6qztZgix8TwLLwdG9wo93M1";
        String sdkKey = "3FhGDDXovhqfzPdGUMqY7JMyMrr6WW8WNcdypYCCvGPf";

//        存放SDK压缩包中的三个.dll文件的路径
        FaceEngine faceEngine = new FaceEngine("E:\\project\\demo\\libs\\WIN32");
        //激活引擎
